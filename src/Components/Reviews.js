...
const Reviews = ({id, prevRating, userRated}) => {
  ...
  return (
    <div className='mt-5 border-t-2 border-gray-700 w-full'>
        <ReactStars
            size={30}
            half={true}
            value={rating}
        ...
        <input 
            ...
            className='w-full p-2 outline-none mt-3 bg-gray-900 header'
        />
        <button onClick={sendReview} className='bg-purple-500 hover:bg-purple-700 flex justify-center w-full p-2'>
